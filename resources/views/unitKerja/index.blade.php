...
<body>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    @foreach ($uker as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->uker }}</td>
                                            <td>
                                                <a type="button" class="btn btn-primary" href="{{url('edit-uker',$item->id)}}" data-bs-toggle="modal" data-bs-target="#editUkerModal{{$item->id}}">
    ...
    @include('unitKerja.modal.tambah')
