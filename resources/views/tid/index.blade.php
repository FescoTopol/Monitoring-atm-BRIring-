    ...
    <div id="app">
        ...
        <div id="main" class='layout-navbar navbar-fixed'>
            ...
            <div id="main-content">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Terminal ID
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data TID BRI BO Tondano</h4>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#tidModal">
                                        <i class="bi bi-folder-plus"></i> Tambah TID
                                    </button>
                            ...
                            <div class="card-body">
                                <table class="table table-striped table-hover">
                                    ...
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach ($terminalId as $item)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $item->tid }}</td>
                                            <td>
                                                <a type="button" class="btn btn-primary" href="{{url('edit-tid',$item->id)}}" data-bs-toggle="modal" data-bs-target="#editTidModal{{$item->id}}">
                ...
                {{-- <form action="{{ route('simpan-pegawai') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambaheModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
