                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Tambah Data Anda</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" action="{{ route('simpan-pegawai') }}" method="POST">
                                                {{ csrf_field() }}
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label for="last-name-column">PN</label>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="uker_id" id="uker_id">
                                                                <option disable value>-- Pilih Uker --</option>
                                                                @foreach ($uk as $item)
                                                                    <option value="{{ $item->id }}">
                                                                        {{ $item->uker }}</option>
                                                                @endforeach
                                                            </select>
                                                            {{-- <label for="city-column">Unit Kerja</label>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label>TID</label>
                                                            <select class="form-control" name="tid_id" id="tid_id">
                                                                <option disable value>-- Pilih TID --</option>
                                                                @foreach ($tid as $item)
                                                                    <option value="{{ $item->id }}">
                                                                        {{ $item->tid }}</option>
                                                                @endforeach
                                                    ...
                                                    <div class="col-12 d-flex justify-content-end">
                                                        <button type="submit" id="toast-success" class="btn btn-primary btn-sm me-1 mb-1">Simpan</button>
                                                        <a type="button" href="/pegawai" class="btn btn-light-secondary me-1 mb-1">Kembali</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
